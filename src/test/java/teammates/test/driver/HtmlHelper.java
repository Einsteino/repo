...
public class HtmlHelper {
    ...
    private static String suppressVariationsInInjectedValues(String content) {
        return content // replace dev server admin absolute URLs (/_ah/...) with their relative counterparts
                      .replace("\"" + TP.TEAMMATES_URL + "/_ah", "\"/_ah")
                      // replace truncated long accounts with their original counterparts
    ...
    private static String replaceUnpredictableValuesWithPlaceholders(String content) {
        ...
        return content // logout URL generated by Google
